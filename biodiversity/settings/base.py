...
STATICFILES_STORAGE = 'biodiversity.storage.NonStrictManifestStaticFilesStorage'
...
GEOSERVER_HOST = 'https://gis.bebif.be/geoserver/wms?'

GEOSERVER_NAMESPACE = 'antarctica'
